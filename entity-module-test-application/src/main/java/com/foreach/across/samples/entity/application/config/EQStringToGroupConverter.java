...
public class EQStringToGroupConverter implements Converter<EQString, Group>
{
	private final GroupRepository groupRepository;

	@Override
	public Group convert( EQString name ) {
		return groupRepository.findByName( name.getValue() );
	}
