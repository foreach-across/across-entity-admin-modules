...
public class DateRangeControl implements ViewElementBuilder<HtmlViewElement>
{
	 ...
	 */
	public static Consumer<EntityPropertyRegistryBuilder.PropertyDescriptorBuilder> build( @NonNull DateRangeEntityTranslator dateRangeEntityTranslator,
	                                                                                       List<DateRange.DateRangeItem> dateRanges ) {
	...
	public HtmlViewElement build( ViewElementBuilderContext builderContext ) {
		...
		DateTimeFormElementConfiguration dateTimeFormElementConfiguration = new DateTimeFormElementConfiguration(
		...
		return html.div( css.of( "custom-date-range-picker" ) )
		           ...
		           .set( data( EntityQueryFilterControlUtils.FilterControlAttributes.OPERAND, EntityQueryOps.EQ.name() ) )
		           .set( data( EntityQueryFilterControlUtils.FilterControlAttributes.PROPERTY_NAME, propertyName ) )
