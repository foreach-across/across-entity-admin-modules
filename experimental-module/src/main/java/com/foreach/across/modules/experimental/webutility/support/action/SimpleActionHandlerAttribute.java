...
public class SimpleActionHandlerAttribute<SELF extends SimpleActionHandlerAttribute<SELF>> extends ActionHandlerAttribute<SELF>
{
	...
	/**
	 * {@link SimpleActionHandlerAttribute} that resolves the id of an instance based on the url within a response object.
	 * The resolved is subsequently used as a query parameter in later {@link RequestActionHandlerAttribute}s.
	 * The provided target will be used as the query parameter for the resolved id.
	 *
	 * @see RequestActionHandlerAttribute#additionalQueryParameter(String, Object)
	 */
	public static SimpleActionHandlerAttribute responseUrlIdResolver( String target ) {
		return simpleActionHandler()
				.type( Type.RESPONSE_URL_ID_RESOLVER )
				.target( target );
	}
	...
	public interface Type
	{
		...
		String RESPONSE_URL_ID_RESOLVER = "exm:response-url-id-resolver";
	}
}
