...
public class TableLinker
{
	 ...
	 */
	public Function<Object, String> buildTargetLink( EntityViewRequest entityViewRequest,
	                                                 Function<EntityViewRequest, LinkDestination> providedLinkDestination ) {
		return ( rowEntity -> {
			...
			String url =
					linkDestination == TableLinker.LinkDestination.DETAIL ? forEntityConfiguration.withFromUrl( currentUrl )
					                                                                              .toUriString() : forEntityConfiguration
