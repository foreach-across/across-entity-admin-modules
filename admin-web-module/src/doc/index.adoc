...
* AdminWebModule now depends on BootstrapUiModule
* the login page now provides an attribute *isLoginPage* that can is accessible in the global template
...
NOTE: The login page uses the same default template as all other admin web controllers.
