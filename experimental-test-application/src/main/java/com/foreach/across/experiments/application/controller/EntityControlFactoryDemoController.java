...
public class EntityControlFactoryDemoController {
    ...
    public String showRegisterForm(Model model,
        ...
        UserResource userResource = UserResource.builder().firstName("Jobs").lastName("Peeters").email("jos.peeters@forach.be").birthDate(LocalDateTime.of(2000, 2, 20, 17, 00)).build();
