 ...
 * @since 2.0.0
 */
public class TestTooltipViewElementBuilder extends AbstractBootstrapViewElementTest
{
	private TooltipViewElementBuilder builder = new TooltipViewElementBuilder();
	...
	public void customizedTooltip() {
		renderAndExpect(
				builder.tagName( "span" ).icon( null ).text( "my text" ).escapeHtml( true ).add( TextViewElement.text( "child" ) ).build( context ),
