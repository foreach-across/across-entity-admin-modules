...
public class TestFormGroupElement extends AbstractBootstrapViewElementTest
{
	...
	public void simpleGroup() {
		renderAndExpect(
				...
				"<div class='form-group'>" +
						...
						"<input  data-bootstrapui-adapter-type='textbox' type='text' class='form-control' name='control' id='control' />" +
						"</div>"
		);
	}
	...
	public void customGroupFromBuilder() {
		renderAndExpect(
				...
				"<div class=\"form-group\">\n" +
						...
						"    <input data-bootstrapui-adapter-type='textbox' type=\"text\" name=\"firstName\" id=\"firstName\" class=\"form-control\" />\n" +
						"    <input data-bootstrapui-adapter-type='textbox' type=\"text\" name=\"lastName\" id=\"lastName\" class=\"form-control\" />\n" +
						"</div>"
		);
	}
	...
	public void withHelpTextOrDescription() {
		...
		renderAndExpect(
				...
				"<div class='form-group'>" +
						"<label for='control' class='control-label'>title</label>" +
						"<input data-bootstrapui-adapter-type='textbox' type='text' class='form-control' name='control' id='control' aria-describedby='control.help' />" +
		...
		renderAndExpect(
				...
				"<div class='form-group'>" +
						...
						"<input data-bootstrapui-adapter-type='textbox' type='text' class='form-control' name='control' id='control' aria-describedby='control.description' />" +
						"</div>"
		);
	...
	public void inlineFormLayoutWithHiddenLabel() {
		...
		renderAndExpect(
				...
				"<div class='form-group'>" +
						...
						"<input data-bootstrapui-adapter-type='textbox' type='text' class='form-control' name='control' id='control' placeholder='title' />" +
						"</div>"
		);
		...
		renderAndExpect(
				...
				"<div class='form-group'>" +
						"<label for='control' class='control-label sr-only'>title</label>" +
						"<input data-bootstrapui-adapter-type='textbox' type='text' class='form-control' name='control' id='control' placeholder='some placeholder' />" +
						"</div>"
		);
		...
		renderAndExpect(
				...
				"<div class='form-group'>" +
						"<label for='control' class='control-label sr-only'>title</label>" +
						"<input data-bootstrapui-adapter-type='textbox' type='text' class='form-control' name='control' id='control' placeholder='' />" +
						"</div>"
		);
		...
		renderAndExpect(
				...
				"<div class='form-group'>" +
						...
						"<div class='input-group'>" +
						INPUT_GROUP_ADDON +
						"<input data-bootstrapui-adapter-type='textbox' type='text' class='form-control' name='control' id='control' placeholder='title input group' />" +
						"</div>" +
						"</div>"
		);
	...
	public void inlineFormDoesNotVisuallyRenderHelp() {
		...
		renderAndExpect(
				...
				"<div class='form-group'>" +
						"<label for='control' class='control-label sr-only'>title</label>" +
						"<input data-bootstrapui-adapter-type='textbox' type='text' class='form-control' name='control' id='control' aria-describedby='control.help' placeholder='title' />" +
						"<p class='help-block sr-only' id='control.help'>example help text</p>" +
						"</div>"
		);
	}
	...
	public void errorFromBoundObject() {
		...
		renderAndExpect(
				...
				"<div class='form-group has-error'>" +
						"<label for='control' class='control-label'>title</label>" +
						"<input data-bootstrapui-adapter-type='textbox' type='text' class='form-control' name='control' id='control' value='test value' />" +
	...
	public void controlNameNotOnBoundObject() {
		...
		renderAndExpect(
				...
				"<div class='form-group'>" +
						...
						"<input data-bootstrapui-adapter-type='textbox' type='text' class='form-control' name='illegalProperty' id='illegalProperty' />" +
						"</div>"
		);
	}
	...
	public void complexControlNameWithError() {
		...
		renderAndExpect(
				...
				"<div class='form-group has-error'>" +
						...
						"<input data-bootstrapui-adapter-type='textbox' type='text' class='form-control' name='values[sub.item].name' id='values[sub.item].name' />" +
