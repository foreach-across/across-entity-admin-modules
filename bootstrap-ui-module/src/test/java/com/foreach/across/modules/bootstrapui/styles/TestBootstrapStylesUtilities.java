...
class TestBootstrapStylesUtilities
{
	...
	@Test
	void fadeAndShow() {
		assertStyle( css.fade ).is( "fade" );
		assertStyle( css.show ).is( "show" );
	}

	@Test
	void active() {
		assertStyle( css.active ).is( "active" );
	}

	@Test
	void disabled() {
		assertStyle( css.disabled ).is( "disabled" );
	}

	@Test
	void slide() {
		assertStyle( css.slide ).is( "slide" );
	}
