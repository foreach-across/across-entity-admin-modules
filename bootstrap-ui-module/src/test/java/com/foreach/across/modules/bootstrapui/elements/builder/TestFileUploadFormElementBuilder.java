...
public class TestFileUploadFormElementBuilder extends AbstractViewElementBuilderTest<FileUploadFormElementBuilder, FileUploadFormElement>
{
	@Override
	protected FileUploadFormElementBuilder createBuilder( ViewElementBuilderFactory builderFactory ) {
