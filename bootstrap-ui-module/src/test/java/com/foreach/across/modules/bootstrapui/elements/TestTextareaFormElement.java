...
public class TestTextareaFormElement extends AbstractBootstrapViewElementTest
{
	...
	public void simpleElement() {
		...
		renderAndExpect(
				box,
				"<textarea data-bootstrapui-adapter-type='textbox' class='form-control js-autosize' placeholder='Text input' rows='3'>" +
	...
	public void transientErrorValueGetsRenderedOnceInsteadOfText() {
		...
		renderAndExpect(
				box,
				"<textarea data-bootstrapui-adapter-type='textbox' class='form-control js-autosize' rows='3'>bad value</textarea>"
		);
		renderAndExpect(
				box,
				"<textarea data-bootstrapui-adapter-type='textbox' class='form-control js-autosize' rows='3'>text</textarea>"
		);
	}
	...
	public void namedTextarea() {
		...
		renderAndExpect(
				box,
				"<textarea data-bootstrapui-adapter-type='textbox' id='internalName' class='form-control' rows='3' name='internalName' />"
		);

		box.setControlName( "controlName" );
		renderAndExpect(
				box,
				"<textarea data-bootstrapui-adapter-type='textbox' id='controlName' class='form-control' rows='3' name='controlName' />"
		);
	}
	...
	public void disabledAndReadonly() {
		...
		renderAndExpect(
				box,
				"<textarea data-bootstrapui-adapter-type='textbox' class='form-control js-autosize' rows='3' disabled='disabled' />"
		);
		...
		renderAndExpect(
				box,
				"<textarea data-bootstrapui-adapter-type='textbox' class='form-control js-autosize' rows='3' readonly='readonly' />"
		);
	}
	...
	public void updateControlName() {
		...
		renderAndExpect(
				control,
				"<textarea data-bootstrapui-adapter-type='textbox' class='form-control js-autosize' rows='3' id='two' name='two' />"
		);
	...
	public void updateControlNameThroughContainer() {
		...
		renderAndExpect(
				control,
				"<textarea data-bootstrapui-adapter-type='textbox' class='form-control js-autosize' rows='3' id='prefix.one' name='prefix.one' />"
		);
