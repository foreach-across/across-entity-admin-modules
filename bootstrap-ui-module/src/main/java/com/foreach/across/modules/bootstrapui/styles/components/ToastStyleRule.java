 ...
 * @since 3.0.0
 */
public class ToastStyleRule implements BootstrapStyleRule
{
	public final BootstrapStyleRule header = of( "toast-header" );
	public final BootstrapStyleRule body = of( "toast-body" );
