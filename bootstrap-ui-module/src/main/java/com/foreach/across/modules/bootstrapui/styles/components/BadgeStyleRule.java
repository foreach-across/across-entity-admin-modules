 ...
 * @since 2.3.0
 */
public class BadgeStyleRule extends ColorStyleRule implements BootstrapStyleRule
{
	public final BootstrapStyleRule pill = of( "badge-pill" );

	public BadgeStyleRule() {
		super( "badge", "badge" );
	}
