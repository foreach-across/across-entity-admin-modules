...
{
	public final BootstrapStyleRule transparent = of( "bg-transparent" );
	public final ColorStyleRule gradient = new ColorStyleRule( "bg-gradient" );

	public BackgroundStyleRule() {
		super( "bg" );
	}
}
