...
export default class ContainerControlAdapter extends BaseControlAdapter {
  ...
  constructor(target: any) {
    ...
    $(target)
      .find(`[data-${BootstrapUiAttributes.CONTROL_ADAPTER_TYPE}]`)
  ...
  getValue(): BootstrapUiControlValueHolder[] {
    return [].concat(
      [].concat(...this.adapters.map(adapter => adapter.getValue()))
    );
  }
 ...
 */
export function createContainerControlAdapter(
  node: any
