...
public class Stages
{
	...
	public static Stage deploySnapshot() {
		String template =
				BUILD_FRONTEND + "\n" +
						DOCKER_COMPOSE + " run --rm maven-base mvn -U --batch-mode clean compile deploy -DskipTests=true -P{profile} -Dmaven.wagon.http.ssl.insecure=true -Dmaven.wagon.http.ssl.allowall=true -Dmaven.wagon.http.ssl.ignore.validity.dates=true";
...
//                                bambooSpecsRepositoryCheckoutTask(),
								       ...
								       new ScpTask()
										       ...
										       .toRemotePath(
												       "/var/www/project-docs.foreach.be/projects/experimental-module" )
										       .authenticateWithKey(
