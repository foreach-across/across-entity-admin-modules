		...
		implements ViewElementNodeBuilder<T>
{
	...
	public List<Node> buildNodes( T viewElement, Arguments arguments, ViewElementNodeFactory viewElementNodeFactory ) {
		Element node = createNode( viewElement, viewElementNodeFactory );

		applyProperties( viewElement, node );
	...
	protected abstract Element createNode( T control, ViewElementNodeFactory viewElementNodeFactory );
