 ...
 */
@Component
public class ManyToManyAssociationJpaSpecificationExecutorListViewBuilder implements AssociationListViewBuilder
{
	@Override
	public boolean supports( Class<?> clazz, Repository repository ) {
		return clazz == ManyToMany.class && repository instanceof JpaSpecificationExecutor;
	}
