...
@AllArgsConstructor
@NoArgsConstructor
public class FormGroupDescriptionTextPostProcessor<T extends ViewElement> extends AbstractPropertyDescriptorAwarePostProcessor<T, FormGroupElement>
{
	/**
	 * -- SETTER --
	...
	protected void postProcess( ViewElementBuilderContext builderContext, FormGroupElement element, EntityPropertyDescriptor propertyDescriptor ) {
		if ( element.getDescriptionBlock() == null ) {
