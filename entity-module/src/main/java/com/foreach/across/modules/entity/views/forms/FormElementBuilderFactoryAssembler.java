 ...
 * {@link com.foreach.across.modules.entity.views.forms.FormElementBuilderFactory} for a
 * {@link com.foreach.across.modules.entity.registry.properties.EntityPropertyDescriptor} instance.
 *
 * @author Arne Vandamme
 */
public interface FormElementBuilderFactoryAssembler
{
	/**
	 * Form element type that this assembler supports.  It can create builder factories for these types.
	 *
	 * @param formElementType Unique type string.
	 * @return True if it can create a builder factory for this element type.
	 */
	boolean supports( String formElementType );

	FormElementBuilderFactory createBuilderFactory(
