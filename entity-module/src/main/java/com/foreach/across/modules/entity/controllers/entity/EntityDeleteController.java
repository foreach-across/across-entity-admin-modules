...
public class EntityDeleteController extends EntityControllerSupport
{
	...
	protected boolean isAllowedAccess( EntityConfiguration entityConfiguration, AllowableActions allowableActions ) {
		return allowableActions.contains( AllowableAction.DELETE );
	}
	...
	public String deleteEntity(
		...
		if ( !bindingResult.hasErrors() ) {
			try {
				entityModel.delete( viewRequest.getEntity() );
		...
		return showDeleteEntityForm( entityConfiguration, viewRequest, adminMenu, model );
	}
