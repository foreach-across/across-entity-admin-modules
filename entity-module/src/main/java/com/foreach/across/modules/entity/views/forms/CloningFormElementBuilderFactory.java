 ...
 * that takes an instance of a {@link com.foreach.across.modules.entity.views.forms.FormElementBuilder} as a template,
 ...
 */
public class CloningFormElementBuilderFactory<T extends FormElementBuilder>
		implements FormElementBuilderFactory<T>
{
	private final Class<T> builderClass;

	private T builderTemplate;

	public CloningFormElementBuilderFactory( Class<T> builderClass ) {
