...
/**
 * Allows creation of an EntityQueryPropertyEmailControl for a given node and EntityQueryFilterControl
 * if the given node is an input of type "email".
 ...
 */
export function createEmailControl( node, control, filterControl ) {
  if ( $( control ).is( "input[type=email]" ) ) {
