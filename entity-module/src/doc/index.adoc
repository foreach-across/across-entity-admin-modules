...
:javadoc: http://across.foreach.be/docs/across-standard-modules/EntityModule/2.0.0-SNAPSHOT/javadoc
...
Some of these may or may not be available depending on how the entity was registered.
...
TODO: OptionGenerator, OptionIterableBuilder, EntityAttribute.OPTIONS_ENTITY_QUERY

TODO: enums as entities!
