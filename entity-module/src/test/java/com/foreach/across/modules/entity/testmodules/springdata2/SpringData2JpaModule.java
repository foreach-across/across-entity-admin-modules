...
public class SpringData2JpaModule extends AcrossModule implements HibernatePackageConfiguringModule
{
	public SpringData2JpaModule() {
	}

	@Override
	public String getName() {
		return "SpringData2JpaModule";
	}
