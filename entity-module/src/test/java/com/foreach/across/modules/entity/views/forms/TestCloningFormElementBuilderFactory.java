 ...
 */
public class TestCloningFormElementBuilderFactory
{
	@Test
	public void emptyInstanceIsReturnedWithoutTemplate() {
		FormElementBuilderFactory<TextboxFormElementBuilder> factory
				= new CloningFormElementBuilderFactory<>( TextboxFormElementBuilder.class );
	...
	public void templateIsDuplicated() {
		CloningFormElementBuilderFactory<TextboxFormElementBuilder> factory
				= new CloningFormElementBuilderFactory<>( TextboxFormElementBuilder.class );
