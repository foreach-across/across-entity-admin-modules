...
public class TestSortableTableRenderingViewProcessor
{
	...
	public void setUp() throws Exception {
		...
		when( entityView.getAttribute( SortableTableRenderingViewProcessor.ATTRIBUTE_ITEMS, Iterable.class ) ).thenReturn( page );
	}
	...
	public void noTableIsBuiltIfNoPageIsPresent() {
		when( entityView.getAttribute( SortableTableRenderingViewProcessor.ATTRIBUTE_ITEMS, Iterable.class ) ).thenReturn( null );

		processor.createViewElementBuilders( viewRequest, entityView, builderMap );
		verify( entityView ).getAttribute( SortableTableRenderingViewProcessor.ATTRIBUTE_ITEMS, Iterable.class );
	...
	public void customSettingsAndDefaultActions() {
		...
		when( entityView.getAttribute( SortableTableRenderingViewProcessor.ATTRIBUTE_ITEMS, Iterable.class ) ).thenReturn( items );
